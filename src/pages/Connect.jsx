...
const perms = [
  {
    ...
    label: "Google Drive",
    desc: "Contracts and documents",
  },
  {
    icon: "skill-icons:gmail-dark",
    label: "Gmail & Sheets",
    desc: "Client communication and financial data",
  },
  {
    icon: "logos:google-calendar",
    label: "Google Calendar",
    desc: "Meeting load and deadlines",
  },
];
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
          ...
          <p className="text-sm text-slate-400 text-center mb-8 leading-relaxed">
            BizWatch reads your data to generate insights. No raw data is
            stored.
          </p>
          ...
          <div className="flex items-start gap-2 text-xs text-slate-500 mb-8 px-1">
            ...
            <span className="leading-relaxed">
              BizWatch reads your data to generate insights. No raw data is
              stored. You can disconnect at any time.
            </span>
          </div>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
              ...
              <path
                fill="#FBBC05"
                d="M4.5 10.48A4.8 4.8 0 0 1 4.25 9c0-.51.09-1 .25-1.48V5.45H1.83a8 8 0 0 0 0 7.1l2.67-2.07z"
              />
              <path
                fill="#EA4335"
                d="M8.98 3.72c1.22 0 2.31.42 3.17 1.25l2.37-2.38A8 8 0 0 0 1.83 5.45L4.5 7.52A4.77 4.77 0 0 1 8.98 3.72z"
              />
            </svg>
            Connect with Google
          </button>
